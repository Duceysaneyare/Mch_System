                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                    include("src/conn.php");
                                    $readQry = mysqli_query($conn,"SELECT * FROM `resources`");
                                    ?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            ...
                                            <td><a href="<?= $row['link']; ?>" target="_blank">View</a></td>
                                             ...
                                             <td colspan="2">
                                                    <form action="updateresources.php" method="post">
                                                        <input type="hidden" name="update_data"
                                                            value="<?php echo $row['id'] ?>">
                                                        <button type="submit" name="update_r"
                                ...
                                <div class="modal fade" id="savemodal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="insert/insertresource.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Delete Resources Data</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <form Action="delete/deleterec.php" method="post"
