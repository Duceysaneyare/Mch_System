                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="card ml-5">
                                <div class="card-body">
                                    ...
                                    if(isset($_POST['update_ch'])){
                                        ...
                                        $query = mysqli_query($conn,"SELECT * FROM `children` WHERE `id` ='$id'");
                                    ...
                                    <form Action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="update_data" id="update_data"
                                          ...
                                          <input class="form-control" name="name" id="name"  value="<?php echo $row['name']?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="birth_time"  id="birth_time"  value="<?php echo $row['birth_time']?>">
                        </div>
                        <div class="form-group">
                            <label>Weight</label>
                            <input type="number" step="0.01" class="form-control" name="weight" id="weight"  value="<?php echo $row['weight']?>">
                        </div>
                        <div class="form-group">
                            <label>Complications</label>
                            <input type="text" class="form-control" name="complications" id="complications" value="<?php echo $row['complications']?>">
                        </div>
                        <div class="form-group">
                      <label>Gender</label>
                     ...
                     <option value="female" <?php if($row['gender'] == 'female') echo 'selected'; ?>>Female</option>
                                ...
                                <div class="modal-footer">
                                    <a href="children_list.php" class="btn btn-secondary" data-dismiss="modal">Back</a>
             ...
             if(isset($_POST['update']))
             {
                ...
                $mother_id = $_POST['mother_id'];
                 ...
                 $gender = $_POST['gender'];
                    ...
                    $queryUpdate = mysqli_query($conn, "UPDATE `children` SET mother_id ='$mother_id', name='$name', birth_date='$birth_date',weight='$weight',complications='$complications',gender='$gender' WHERE id='$id' ");
                    if ($queryUpdate)
                    {
