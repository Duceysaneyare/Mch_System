                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <td><?php echo $row['id']; ?></td>
                                                ...
                                                <td colspan="2">
                                                    <form action="updatechildren.php" method="post">
                                                        <input type="hidden" name="update_data"
                                                            value="<?php echo $row['id'] ?>">
                                                        <button type="submit" name="update_ch"
                                ...
                                <div class="modal fade" id="savemodal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="insert/insertchild.php" method="post" enctype="multipart/form-data">
                            ...
                            <option value="">Select Mother</option>
                                <?php
                                $motherQry = mysqli_query($conn, "SELECT * FROM mothers");
                                while ($motherRow = mysqli_fetch_assoc($motherQry)) {
                                    echo "<option value='" . $motherRow['id'] . "'>" . $motherRow['mother_name'] . "</option>";
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="complications"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Gender</label>
                            <select class="form-control" name="gender" required>
                                ...
                                <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Delete Children Data</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <form Action="delete/deletechild.php" method="post"
